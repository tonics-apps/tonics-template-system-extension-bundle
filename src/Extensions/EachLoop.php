...
namespace Devsrealm\TonicsTemplateSystemExtensionBundle\Extensions;
...
use Devsrealm\TonicsTemplateSystemExtensionBundle\Helpers;
    ...
    public function render(string $content, array $args, array $nodes = []): string
    {
        ...
        foreach ($loopVariable ?? [] as $key => $loop) {
            ...
            foreach ($tag->getChildrenRecursive($tag) as $node) {
                ...
                Helpers::GarbageCollect(); # temporary solution to reduce memory increment in larger each loops.
                ++$n;
            }
            ++$iteration;
        }
